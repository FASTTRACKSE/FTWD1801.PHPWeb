...
<body>
	...
	// lấy dữ liệu từ form
		...
		if (isset($_POST['submit'])) {
			...
			$full_part = $part_root .'/FTWD1801.PHPWeb/nampt/php_day4/images/'. $img_name;
	...
	<table>
		...
		<tr>	
			...
			<td><?= $key ?></td>
			<td><?= $value['name'] ?></td>
			<td><img src='<?= "images/$value[img_name]" ?>' width='100' height='100' ></td>
			<td><?= $value['gender'] ?></td>
			<td><?= $value['address'] ?></td>
			<td><a href="asm.php?user=<?=$key?>">Xóa</a></td>
		</tr>	
		<?php }  ?>				
	</table>
</body>
