...
<h5 class="title"><a href="<?=base_url()?>home"> TRANG CHỦ</a> / <a href="<?=base_url()?>home/donam"> ĐỒ NAM </a>/<a href="<?=base_url()?>home/quanshort_nam">QUẦN SHORT</a> </h5>
<br><br>
          ...
          <article class="col-main">
            ...
            <div class="category-products">
              <ul class="products-grid">
                <?php foreach ($quanshort_nam as $key => $value) {?>
