                    ...
                    <div class="card">
                     ...
                     <?php foreach ( $item as $item ) {?>
                      <div class="card-body card-block">
                        ...
                        <div class="form-group">
                            <label for="vat" class=" form-control-label" >ngày_nhập</label>
                            <input type="text" id="vat"  class="form-control" name="ngay_nhap" value="<?=$item["ngay_nhap"]?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="vat" class=" form-control-label" >số lượng_còn</label>
                            <input type="text" id="vat"  class="form-control" name="soluong_con" value="<?=$item["soluong_con"]?>">
                        </div>
