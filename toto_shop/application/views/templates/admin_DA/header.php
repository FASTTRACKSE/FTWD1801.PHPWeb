...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/css/normalize.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/css/themify-icons.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/css/flag-icon.min.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/css/cs-skin-elastic.css">
    <!-- <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/css/bootstrap-select.less"> -->
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/assets/scss/style.css">
    <link href="<?=base_url()?>assets/backend/assets/css/lib/vector-map/jqvmap.min.css" rel="stylesheet">

    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>

    <script src="<?= base_url('public/admin/plugins/')?>ckeditor/ckeditor.js"></script>
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                          ...
                          <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                                <span class="photo media-left"><img alt="avatar" src="<?=base_url()?>assets/backend/assets/images/avatar/1.jpg"></span>
                            ...
                            <a class="dropdown-item media bg-flat-color-4" href="#">
                                <span class="photo media-left"><img alt="avatar" src="<?=base_url()?>assets/backend/assets/images/avatar/2.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-5" href="#">
                                <span class="photo media-left"><img alt="avatar" src="<?=base_url()?>assets/backend/assets/images/avatar/3.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-3" href="#">
                                <span class="photo media-left"><img alt="avatar" src="<?=base_url()?>assets/backend/assets/images/avatar/4.jpg"></span>
                                <span class="message media-body">
